...
#ifndef _HPC_TIANYI_COMMON_LOG_H_
#define _HPC_TIANYI_COMMON_LOG_H_
...
#if defined(__ATIANYIE__) && (defined(__GNUC__) || defined(__xlC__) || defined(__xlc__))
...
#define LOG(___level___)                                                                                             \
    (tianyi::common::LOG_LEVEL_##___level___ < tianyi::common::GetCurrentLogger()->GetLogLevel())                          \
        ? (void)0                                                                                                    \
        : tianyi::common::DummyOperatorPlaceHolder() &                                                                  \
            tianyi::common::LogMessage(tianyi::common::LOG_LEVEL_##___level___, tianyi::common::GetCurrentLogger(), __FILE__, \
                                    __LINE__)
